            ...
            Card(
              child: Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 12),
                  TextField(controller: _storePhone, keyboardType: TextInputType.phone, decoration: const InputDecoration(labelText: 'No HP Toko', prefixText: '+62 ', isDense: true)),
                  const SizedBox(height: 16),
                  const Divider(),
                  ...
                  const SizedBox(height: 12),
                  TextField(controller: _adminPhone, keyboardType: TextInputType.phone, decoration: const InputDecoration(labelText: 'No HP Admin (untuk login)', prefixText: '+62 ', isDense: true)),
                  const SizedBox(height: 12),
