    ...
    return Scaffold(
      ...
      body: order.when(
        ...
        data: (o) => ListView(padding: const EdgeInsets.all(16), children: [
          ...
          InfoCard(title: 'Pelanggan', rows: {'Nama': o.customerName, 'HP': o.customerPhone, 'Device': o.deviceName, 'Alamat': o.deliveryAddress ?? '-'}),
          if (o.credentialPanel != null) CredentialCard(panel: o.credentialPanel!),
          InfoCard(title: 'Harga', rows: {'Estimasi': money(o.estimatedTotal), 'Final': money(o.finalPrice), 'Payment': o.paymentStatus}),
