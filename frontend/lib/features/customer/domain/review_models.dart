...
class CouponReward {
  const CouponReward(
      {required this.code, required this.amount, required this.expiredAt});
  final String code;
  final double amount;
  ...
  factory CouponReward.fromJson(Map<String, dynamic> json) => CouponReward(
        ...
        expiredAt: dateFromJson(json['expired_at'] ?? json['expiredAt']) ??
            DateTime.now(),
      );
}
...
class ReviewResult {
  ...
  factory ReviewResult.fromJson(Map<String, dynamic> json) => ReviewResult(
        ...
        coupon: json['coupon'] is Map<String, dynamic>
            ? CouponReward.fromJson(json['coupon'] as Map<String, dynamic>)
            : null,
      );
}
