    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text('Acuan Phase 02: backend wajib cek warrantyExpiredAt dan dispute aktif.'),
          const SizedBox(height: 20),
          DropdownButtonFormField<String>(
            decoration: const InputDecoration(labelText: 'Jenis klaim', border: OutlineInputBorder()),
            items: const [
              DropdownMenuItem(value: 'warranty_claim', child: Text('Warranty claim')),
              DropdownMenuItem(value: 'service_quality', child: Text('Service quality')),
              DropdownMenuItem(value: 'wrong_diagnosis', child: Text('Wrong diagnosis')),
